...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="200" height="301" border="0" align="left" cellpadding="0" cellspacing="2" class="table">
      <tr>
      ...
      <tr>
        <td height="65" valign="top" class="cell">
          ...
          <a href="Help_Desk.php"><br>Help Desk</a>
          <a href="Find_Player.php">Find Player</a>
        </td>
      </tr>
      <tr class="header">
      ...
      <tr class="cell">
        <td height="23">
          ...
          <a href="Help_Desk_Reply.php">Help Desk</a>
        </td>
      </tr>
      <?php } ?>
      <tr class="header">
